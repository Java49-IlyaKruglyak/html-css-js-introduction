...
//console.log(httpPrefix + moviesData.results[1].poster_path);

const ulElement = document.querySelector(".movies-list");
const sectionElements = document.querySelectorAll("section");
ulElement.innerHTML = getPosterImages();
function getPosterImages() {
    const arImages = moviesData.results.map(movie => `<li class="movie-item"> <img class="movie-image" src="${httpPrefix}${movie.poster_path}"></li>`);
